...
Start with `docs/public-boundary.md`, then add or update the smallest complete
public slice needed for the platform, service, or adapter. Include focused
tests for behavior, failure modes, tenant boundaries, and portability; record
only synthetic evidence for repository-level operational claims.
